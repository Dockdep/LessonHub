...
public class AiExerciseRetryRequest : IAiRequestWithApiKey, IAiTechnicalRequest
{
    ...
    /// used to ground the retry exercise in RAG context. Independent of LessonType.</summary>
